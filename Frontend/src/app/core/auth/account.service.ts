...
export class AccountService {
  ...
  save(account: UserUpdateRequest): Observable<{}> {
    return this.http.put(this.applicationConfigService.getEndpointFor('api/auth/me'), account);
  }
  ...
  private fetch(): Observable<Account> {
    return this.http.get<Account>(this.applicationConfigService.getEndpointFor('api/auth/profile'));
    // return this.http.get<Account>(this.applicationConfigService.getEndpointFor('api/auth/me'));
  }
